...
<script type="text/javascript" src="<c:url value="/static/js/structurizr-model-form-editor.js" />"></script>
<link rel="stylesheet" href="<c:url value="/static/css/structurizr-model-form-editor.css" />">
